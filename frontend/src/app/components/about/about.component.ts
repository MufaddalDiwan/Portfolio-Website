import { Component, OnInit, OnDestroy, ElementRef, ViewChild, SecurityContext } from '@angular/core';
...
export class AboutComponent implements OnInit, OnDestroy {
  ...
  private renderBio(markdown: string): void {
    try {
      ...
      this.renderedBio = this.sanitizer.bypassSecurityTrustHtml('<p>Unable to render bio content.</p>');
    }
  }
