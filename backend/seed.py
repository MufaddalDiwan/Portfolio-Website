...
- Optimized performance with lazy loading and code splitting''',
            'tech': ['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Redis', 'Stripe API', 'Docker', 'Elasticsearch'],
...
- Lazy loading of non-critical components''',
            'tech': ['Vue.js', 'Python', 'Flask', 'PostgreSQL', 'Socket.IO', 'JWT', 'Vuex', 'Tailwind CSS'],
...
- Asynchronous processing with Celery workers''',
            'tech': ['Angular', 'Python', 'FastAPI', 'Apache Kafka', 'ClickHouse', 'Redis', 'Kubernetes', 'D3.js'],
...
Built using React Native for cross-platform compatibility, with a Node.js backend consuming multiple weather APIs for data accuracy.''',
            'tech': ['React Native', 'Node.js', 'Express', 'MongoDB', 'Weather APIs', 'Push Notifications'],
...
Built with Next.js for server-side rendering, Prisma for database management, and Cloudinary for image optimization.''',
            'tech': ['Next.js', 'Prisma', 'PostgreSQL', 'Cloudinary', 'Tailwind CSS', 'NextAuth.js'],
...
Built with Django REST Framework, featuring JWT authentication, rate limiting, and comprehensive API documentation with Swagger.''',
            'tech': ['Django', 'Django REST Framework', 'PostgreSQL', 'Redis', 'Celery', 'JWT', 'Swagger'],
    ...
    experiences = [
        {
            ...
            'tech': ['React', 'Node.js', 'PostgreSQL', 'Apache Kafka', 'Docker', 'Kubernetes', 'AWS'],
            'order_index': 1
        },
        {
            'company': 'StartupXYZ',
...
I'm always excited to take on new challenges and collaborate with talented teams to build amazing products.''',
        social_links=[
            {
                'platform': 'GitHub',
                'url': 'https://github.com/MufaddalDiwan',
                'icon': 'github'
            },
            {
                'platform': 'LinkedIn',
            ...
            {
                'platform': 'Email',
                'url': 'mailto:mufaddaldiwan21@gmail.com',
                'icon': 'email'
            }
        ]
    )
    ...
    for image_name in image_names:
        ...
        if not os.path.exists(image_path):
            ...
            with open(image_path, 'w') as f:
                ...
                f.write(f"# Recommended size: 800x600px or 16:9 aspect ratio\n")
...
def main():
    ...
    with app.app_context():
        try:
            ...
            print(f"  • 9 placeholder images created")
            
            print("\nNext steps:")
            print("  1. Replace placeholder images in content/images/projects/ with actual screenshots")
            print("  2. Update site metadata in Flask-Admin (/admin) with your personal information")
