...
from marshmallow import Schema, fields, validate, validates_schema, ValidationError, post_dump, pre_load
    ...
    def validate_social_links(self, data, **kwargs):
        ...
        if social_links:
            ...
            for link in social_links:
                ...
                elif platform == 'twitter' and not any(domain in url for domain in ['twitter.com', 'x.com']):
